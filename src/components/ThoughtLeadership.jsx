    ...
    <section className="bg-white py-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
          <img
            ...
            className="w-[636px] h-[382.6611022949219px] rounded-2xl shadow-md object-cover"
          />
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-[#002d2d] to-[#001f3f] h-[350px] rounded-xl p-8 md:p-12 text-white text-center mx-4 md:mx-16 my-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="w-full pt-[40px] flex md:flex-row flex-col z-10 items-center justify-center gap-[20px]">
            {/* Updated: Become a member navigates to /engage#becomeamember */}
            <Link
              to="/engage#becomeamember"
              className="px-6 py-[12px] rounded-full font-semibold text-white bg-transparent transition-all duration-300 ease-in-out shadow-none text-[16px] font-['Inter'] border-white cursor-pointer border hover:bg-[#DFEFFF] hover:text-[#005BA9] hover:-translate-y-1 hover:rounded-full hover:shadow-[4px_4px_0_0_#005BA9] active:bg-[#005BA9] active:text-white active:border-[4px] active:border-white active:shadow-none"
            >
              Become a member
            </Link>

            <button className="px-6 py-[12px] rounded-full font-semibold text-white bg-transparent transition-all duration-300 ease-in-out shadow-none text-[16px] font-['Inter'] border-white border cursor-pointer hover:bg-[#DFEFFF] hover:text-[#005BA9] hover:-translate-y-1 hover:rounded-full hover:shadow-[4px_4px_0_0_#005BA9] active:bg-[#005BA9] active:text-white active:border-[4px] active:border-white active:shadow-none">
              Sponsor a Program
            </button>
      ...
      <footer className="bg-gradient-to-r from-[#001f2b] to-[#000d1a] text-white py-10 px-6 md:px-20 rounded-t-3xl mt-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-2 text-sm text-gray-300">
            ...
            <h3 className="text-white font-Intter font-medium mb-2">Address</h3>
            ...
            <div className="flex space-x-4 w-full gap-[40px] justify-end text-xl text-white ">
              <a href="/linkedin" className="hover:text-blue-500 w-[20.97px] h-[20.97px] text-[#C0C0C0]">
                <i className="fab fa-linkedin fa-lg"></i>
              </a>
              <a href="/twitter" className="hover:text-blue-400 w-[20px] h-[20px] text-[#C0C0C0]">
                <i className="fab fa-x-twitter fa-lg"></i>
              </a>
              <a href="/youtube" className="hover:text-red-500 w-[28px] h-[20px] text-[#C0C0C0] ">
